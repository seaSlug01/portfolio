  ...
  return (
    <Container onClick={() => setText({ ...text, show: !text.show })}>
      <Group>
        ...
        <Label as="div" theme={theme}>
          My Phone Number:
        </Label>
      </Group>
      <Group>
        <Paragraph
          className={`${text.show ? "show" : undefined}`}
          theme={theme}
        >
          +30 6942.......Hah...
          {text.show &&
            text.str.split("").map((letter, i) => (
              <Letter
                onAnimationEnd={() => {
...
const Paragraph = styled.p`
  ...
  &::after {
    ...
    background: ${(props) =>
      props.theme === "dark"
        ? "linear-gradient(to right, rgba(50, 50, 50, 0.5) 0%, rgba(50, 50, 50, 1) 10%)"
        : "linear-gradient(to right, rgba(249, 249, 249, 0.5) 0%, rgba(249, 249, 249, 1) 10%)"};
    top: 0;
    right: 0;
    display: block;
  }
